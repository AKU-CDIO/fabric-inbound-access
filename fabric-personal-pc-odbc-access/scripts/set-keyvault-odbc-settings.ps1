param(
    ...
    [ValidateSet("uzima_db_backup", "HCW_fitbit_data", "Qualtrics")]
...
if ($connectionString -match "Interactive") {
    throw "Connection string must use managed identity auth, not browser or email sign-in."
}
...
Write-Host ""
Write-Host "Stored managed-identity ODBC connection string for database: $Database"
